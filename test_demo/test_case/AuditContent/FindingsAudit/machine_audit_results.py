...
class Machine_Audit_Results(unittest.TestCase):
    ...
    dataxpath = "/html/body/div/div/div[2]/section/section/div/div/div/div/div[2]/div[1]/div/div[2]/div[3]/table/tbody/tr[{}]/td[{}]/div"  # 机审结果内容的xpath
    dataxpath2 = "/html/body/div/div/div[2]/section/section/div/div/div/div/div[2]/div[1]/div/div[2]/div[3]/table/tbody"  # 统计机审结果内容的xpath
    ...
    @staticmethod
    def UploadOrederAndWrite(driver, ccount):  # 上传ccount张工单，并记录工单信息，机审结果，进入workorderdata.xls
        # 打开审核结果页面
        driver = Machine_Audit_Results.OpenAuditResults(driver)
        # 记录第一条工单的工单id
        befor_first_order_id = Machine_Audit_Results.GetOderID(driver, 1)
