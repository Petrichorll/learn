...
String name = "张三"
generateImg(name, "/Users/xingchenge/Desktop/temp", name)
}
...
int
len = beautifulColors.length
Random
random = new
Random()
String[]
color = beautifulColors[random.nextInt(len)].split(",")
return new
Color(Integer.parseInt(color[0]), Integer.parseInt(color[1]),
...
static
BufferedImage
makeRoundedCorner(BufferedImage
image, int
cornerRadius){
    int
w = image.getWidth()
...
g2.fill(new
RoundRectangle2D.Float(0, 0, w, h, cornerRadius, cornerRadius))
